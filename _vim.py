...
basics_mapping = aenea.configuration.make_grammar_commands('vim', {
    ...
    'save': Key("escape/10, colon, w, enter"),
    'save and quit': Key("escape/10, colon, w, q, enter"),
    'quit all': Key("escape/10, colon, q, a, enter"),
    'discard': Key("escape/10, colon, q, exclamation"),
    ...
    'indent auto': Key("equal"),
    'indent (decrease|less) [<n>]': Key("langle:%(n)d"),
    'indent (increase|more) [<n>]': Key("rangle:%(n)d"),
    'yine': Key("escape, y:2"),
