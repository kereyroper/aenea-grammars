...
terminal_mapping = aenea.configuration.make_grammar_commands('terminal', {
    ...
    'hub deploy int': Text('eatsa-deploy -e int deploy -a hub -s all'),
    ...
    'hub list int': Text('eatsa-deploy -e int deploy -a hub -r') + Key("enter"),
    'hub list prod': Text('eatsa-deploy -e prod deploy -a hub -r') + Key("enter"),
    'hub list stage': Text('eatsa-deploy -e stage deploy -a hub -r') + Key("enter"),
    'hub shell int': Text('eatsa-deploy -e int connect hub-shell') + Key("enter"),
    'hub shell prod': Text('eatsa-deploy -e prod connect hub-shell') + Key("enter"),
    'hub shell stage': Text('eatsa-deploy -e stage connect hub-shell') + Key("enter"),
