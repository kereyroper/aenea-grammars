...
terminal_mapping = aenea.configuration.make_grammar_commands('terminal', {
    ...
    'hub (config|configure) wow bow': Text('eatsa-deploy -e wowbao config -e hub/common-config.yaml'),
    ...
    'hub deploy wow bow': Text('eatsa-deploy -e wowbao deploy -a hub -s one'),
    ...
    'hub list wow bow': Text('eatsa-deploy -e wowbao deploy -a hub -r') + Key("enter"),
    ...
    'hub shell wow bow': Text('eatsa-deploy -e wowbao connect hub-shell') + Key("enter"),
    ...
    'router (config|configure) wow bow': Text('eatsa-deploy -e wowbao config -e router/common-config.yaml'),
    ...
    'router deploy wow bow': Text('eatsa-deploy -e wowbao deploy -a router -s all'),
    ...
    'router list wow bow': Text('eatsa-deploy -e wowbao deploy -a router -r') + Key("enter"),
